% Backpropagation for 5-layer Networks
%
% model=bptrain4(P,T,h,act,lr,mr,pr,maxIt,minSmE)
%
...
%
function model=bptrain4(P,T,h,act,lr,mr,pr,maxIt,minSmE)
if nargin<9,
   minSmE=1e-8;
end
if nargin<8,
